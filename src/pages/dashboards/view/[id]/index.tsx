        ...
        {isLoading ? (
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                <FormListItem label="Task Column" text={data?.task_column} />

                <FormListItem label="Progress Bar" text={data?.progress_bar} />

                <FormListItem label="Tilsynsrapport Field" text={data?.tilsynsrapport_field} />

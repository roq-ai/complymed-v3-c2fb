  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to ComplyMED v3 - Your comprehensive compliance management system. Visually track actionable tasks, communicate with team members, and ensure your business meets all regulatory standards. Your pathway to effortless compliance starts here."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to ComplyMED v3 - Your comprehensive compliance management system. Visually track actionable tasks, communicate with team members, and ensure your business meets all regulatory standards. Your pathway to effortless compliance starts here.`}
            </Text>
            <Box
